               ...
               <div className="max-w-screen-md mx-auto p-8">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-md mx-auto">
                         <div className="mb-4">
                              ...
                              <input type="text" id="fullName" name="fullName" className="input input-bordered w-full transition-all duration-300 focus:outline-none focus:ring focus:border-blue-400" {...register("fullName", { required: true })} />
                         ...
                         <div className="mb-4">
                              ...
                              <input type="Text" id="image" name="image" className="input input-bordered w-full" {...register("image",{ required: true })} />
