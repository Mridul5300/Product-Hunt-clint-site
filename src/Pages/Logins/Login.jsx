...
//   console.log("your location", location);
    ...
    signIn(email, password)
     ...
     return (
      ...
      <div className="hero-content mt-2 flex flex-col lg:flex-row">

        <div className="lg:w-1/2">
          <img src="https://i.ibb.co/t39f53Q/7973703-3807931.jpg" alt="Login Illustration" className="w-full h-auto" />
        </div>
        <div className="lg:w-1/2 flex flex-col justify-center">
          <div className="card shrink-0 w-[450px] mt-4 shadow-2xl bg-base-100">
            ...
            <div className="mb-5">
              ...
              <div className="flex justify-center space-x-4">
                <button onClick={() => handleSociallogin(googleLogin)} aria-label="Log in with Google" className="btn btn-link p-3 rounded-sm">
